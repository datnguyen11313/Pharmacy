...
public class MedicinesEntity {
	...
	public MedicinesEntity(int id, String medicine_name, int category_id, int price, int stock, LocalDate manufacturing_date,
			LocalDate expiry_date, boolean isDelete) {
		super();
		this.id = id;
